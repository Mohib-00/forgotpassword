                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                        <button class="addsupport3">Add Row</button>
                    </div>
                  </div>
                  <div class="card-body">
                            ...
                            <tr class="user-row" id="support3-{{ $support3->id }}">
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a id="support3edit" data-support3-id="{{ $support3->id }}" class="btn btn-link btn-primary btn-lg edit-support3-btn">
                                                 <i class="fa fa-edit"></i>
                                            </a>
                                       
                                            <a data-support3-id="{{ $support3->id }}" class="btn btn-link btn-danger mt-2 delsupport3">
        ...
        success: function (response) {
            ...
            if (response.success) {
                Swal.fire({
                    ...
                    support3.find('td:nth-child(3)').text(response.support3.paragraph);
                });
            } else {
                Swal.fire({
                    icon: 'error',
